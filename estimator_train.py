...
flags = tf.app.flags
FLAGS = flags.FLAGS
flags.DEFINE_string("config_file", "bert.yml", "config file used to train the model.")
flags.DEFINE_string("config_name", "bert_base", "config name used to train the model.")
flags.DEFINE_string("input_file", "train.english.record", "training file.")
flags.DEFINE_string("vocab_file", "vocab.txt", "vocab file for pretraining BERT.")
flags.DEFINE_string("output_dir", "data", "The output directory of the model training.")
flags.DEFINE_bool("do_train", True, "Whether to run training.")
flags.DEFINE_bool("need_preprocess_data", False, "Whether process data or not .")
